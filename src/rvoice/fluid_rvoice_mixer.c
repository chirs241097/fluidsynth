...
struct _fluid_mixer_buffers_t {
  ...
  _Atomic int ready;          /**< Atomic: buffers are ready for mixing */
...
//  int active_threads;         /**< Atomic: number of threads in the thread loop */
  _Atomic int threads_should_terminate; /**< Atomic: Set to TRUE when threads should terminate */
  _Atomic int current_rvoice;   /**< Atomic: for the threads to know next voice to  */
