...
struct _fluid_synth_t
{
  ...
  _Atomic int with_reverb;           /**< Should the synth use the built-in reverb unit? */
  _Atomic int with_chorus;           /**< Should the synth use the built-in chorus unit? */
  ...
  _Atomic unsigned int ticks_since_start;
  ...
  _Atomic float reverb_roomsize;     /**< Shadow of reverb roomsize */
  _Atomic float reverb_damping;      /**< Shadow of reverb damping */
  _Atomic float reverb_width;        /**< Shadow of reverb width */
  _Atomic float reverb_level;        /**< Shadow of reverb level */

  _Atomic int chorus_nr;             /**< Shadow of chorus number */
  _Atomic float chorus_level;        /**< Shadow of chorus level */
  _Atomic float chorus_speed;        /**< Shadow of chorus speed */
  _Atomic float chorus_depth;        /**< Shadow of chorus depth */
  _Atomic int chorus_type;           /**< Shadow of chorus type */
  ...
  _Atomic float cpu_load;            /**< CPU load in percent (CPU time required / audio synthesized time * 100) */
