...
static int fluid_alsa_audio_run_float(void* d);
static int fluid_alsa_audio_run_s16(void* d);
...
static int fluid_alsa_midi_run(void* d);
...
static int fluid_alsa_seq_run(void* d);
